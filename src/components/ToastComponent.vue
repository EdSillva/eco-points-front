<template>
    <div v-if="visible" :class="['fixed top-6 right-6 z-50', ...toastClass]" role="alert">
        <div class="flex p-4">
...
const toastClass = computed(() => {
    return [
        'max-w-xs text-sm text-white rounded-md shadow-lg mb-3 ml-3',
...
setTimeout(() => {
    visible.value = false
    emit('close') // dispara evento pra tela pai reagir
}, 3000)
</script>